...
def main() -> int:
    ...
    parser.add_argument("--date", required=True, help="目标日期，例如 2026-03-20 / 今天 / 昨天")
    ...
    base_url = os.environ.get("FOCUSLEDGER_BASE_URL", "http://127.0.0.1:8100")

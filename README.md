...
- 需要同步某个公众号的历史文章：进入 `/collect`
- 需要把单篇或多篇现成文章快速收入库：进入 `/articles/import`
- 需要整理、筛选、总结文章：进入 `/articles`
- 需要围绕专题做研究：进入 `/notebooks`
